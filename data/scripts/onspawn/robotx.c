...
void main()
{
    ...
    if(level == 4){vAlias = "Skull";}else
    if(level == 3){vAlias = "Hollow";}else
    if(level == 2){vAlias = "Zombie";}else
    if(level == 1){vAlias = "Walker";}else
    {vAlias = "Robot_X";}

    if(vName == "Robotx_Wait"){setglobalvar("RobotxBoss", self);}
